...
const.toplist_minimum <- 200 
const.hosp_toplist_minimum <- 3
...
%s / 344 gemeentes met nieuwe besmettingen (w: %s )   
...
%s / 344 gemeentes met nieuwe meldingen (w: %s )   
