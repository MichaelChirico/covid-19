...
cbs_url <- "https://www.cbs.nl/-/media/_excel/2022/13/doodsoorzaken-2020-december-2021.xlsx"
...
plot <- deaths_total %>%
  dplyr::filter(week_year <= "2021-52") %>%
  ...
  labs(title = "Sterfte per week",
       subtitle = "CBS data beschikbaar t/m december 2021",
