...
cbs_url <- "https://www.cbs.nl/-/media/_excel/2022/19/doodsoorzaken-januari-2022.xlsx"
...
plot <- deaths_total %>%
  dplyr::filter(week_year <= "2022-04") %>%
  ...
  labs(title = "Sterfte per week",
       subtitle = "CBS data beschikbaar t/m januari 2022",
